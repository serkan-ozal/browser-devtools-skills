...
# Only 5xx errors
browser-devtools-cli --json o11y get-http-requests --status '{"min":500,"max":599}'

# Successful only (2xx)
browser-devtools-cli --json o11y get-http-requests --ok

# With request/response headers and body
browser-devtools-cli --json o11y get-http-requests --include-request-headers --include-response-headers --include-response-body
```
